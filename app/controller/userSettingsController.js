app.controller('UserSettingsController', ['$scope', '$location', '$rootScope', 'Services', '$mdToast', '$timeout', '$mdMedia', '$mdDialog', '$window', 'growl', function($scope, $location, $rootScope, Services, $mdToast, $timeout, $mdMedia, $mdDialog, $window, growl) {
